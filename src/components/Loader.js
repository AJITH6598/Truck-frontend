  ...
  return (
    <div style={{
      ...
      <div className="loader-container">
        <svg xmlSpace="preserve" viewBox="0 0 254.532 254.532" xmlns="http://www.w3.org/2000/svg" className="wheel">
          <g>
            <path d="M127.267,0C57.092,0,0,57.091,0,127.266s57.092,127.266,127.267,127.266c70.174,0,127.266-57.091,127.266-127.266
      				...
      				c49.92,0,90.39,40.468,90.39,90.39S177.186,217.656,127.267,217.656z" id="tire" />
            <path d="M127.267,48.578c-43.39,0-78.689,35.299-78.689,78.688c0,43.389,35.3,78.688,78.689,78.688
      				...
      				M179.292,172.23l-27.028-27.028c2.749-3.804,4.654-8.254,5.435-13.079h38.191C194.818,147.398,188.745,161.308,179.292,172.23z" id="rim" />
          </g>
        </svg>
        <div className="road" />
